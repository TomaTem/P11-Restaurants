...
export default function Adding() {
  ...
  function handleSubmit(event) {
    ...
    // if (/[\S]{0,}\s/.test(name) && /[\S]{0,}\s/.test(address)) {
      let link = 'https://img.freepik.com/premium-vector/front-view-of-restaurant-exterior-from-street-cafe-building-with-open-glass-door-window-and-furniture-empty-modern-coffeehouse-from-outside-urban-cafeteria-facade-colored-flat-vector-illustration_198278-16999.jpg?w=1380'
      if (picture.length !== 0) {
        link = picture;
      }
      dispatch({
